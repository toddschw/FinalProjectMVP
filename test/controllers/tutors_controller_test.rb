...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { bio: @tutor.bio, city: @tutor.city, email: @tutor.email, name: @tutor.name, picurl: @tutor.picurl, rate: @tutor.rate }
    end
  ...
  test "should update tutor" do
    patch :update, id: @tutor, tutor: { bio: @tutor.bio, city: @tutor.city, email: @tutor.email, name: @tutor.name, picurl: @tutor.picurl, rate: @tutor.rate }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
